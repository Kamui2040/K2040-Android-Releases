(() => {
  ...
  const ICONS = {
    ...
    android: "https://kamui2040.github.io/assets/icons/k2040-android.webp?v=20260826outline2",
    gaming: "https://kamui2040.github.io/assets/icons/k2040-gaming.webp?v=20260826outline2"
  };

  const footerLinks = [
    ["https://kamui2040.github.io/", "Home"],
    ["/K2040-Android-Releases/", "Android Projects"],
    ["https://kamui2040.github.io/K2040-Gaming-Mods/", "Gaming Mods"],
  ...
  const decorate = (root = document) => root.querySelectorAll?.("a[href]").forEach((link) => {
