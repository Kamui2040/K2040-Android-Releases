(() => {
  ...
  const PLATFORMS = [
    ...
    { key: "onestore", hosts: ["onestore.net", "onestore.co.kr"], labels: ["one store"] },
    { key: "openapk", hosts: ["openapk.net"], labels: ["openapk"] }
  ];
  ...
  const createIcon = (platform) => {
    ...
    if (pathData) {
      ...
      const monograms = { nexus: "N", apkpure: "A", uptodown: "U", onestore: "1", openapk: "O" };
