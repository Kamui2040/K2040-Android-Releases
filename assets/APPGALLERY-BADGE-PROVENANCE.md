...
- Use the badge only to promote content provided on HUAWEI AppGallery.
- Keep the HUAWEI badge at least as large as any other app-store badge.
- Use a badge language matching the surrounding media.
- Online uses must link to HUAWEI AppGallery.
- Do not add the badge and its distribution link to media ads as separate elements.

The repository does not claim ownership of HUAWEI or AppGallery trademarks. The badge remains HUAWEI artwork supplied for AppGallery promotion.
