...
Public version `0.14.0` is a new independent compatibility baseline. Older private Esca data and older backup formats are unsupported.
...
- [Release notes](release-notes/esca-agnellis-v0.14.0-beta.1.en.md)
- [Checksum](checksums/Esca-Agnellis-v0.14.0-vc37-release.apk.sha256)
