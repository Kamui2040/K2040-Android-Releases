// Canonical public Android update feed. New records belong here; page-specific renderers own presentation.
window.K2040_CONTENT = {
  updates: [
    ...
    },
    {
      ...
      strings: {
        en: { category: "GeoJoystick", title: "GeoJoystick v0.1.4 now on ONE store and OpenAPK", summary: "The developer-signed v0.1.4 release is now available through ONE store and OpenAPK as additional official download channels." },
